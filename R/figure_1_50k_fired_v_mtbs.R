...
ggsave(file = file.path(draft_figs_dir, "figure_1_fired_vs_mtbs.pdf"), 
       g, width = 8.5, height = 11, dpi = 600, scale = 3, units = "cm") 

ggsave(file = file.path(draft_figs_dir, "figure_1_fired_vs_mtbs.png"), 
